...
class ReproductiveSpider(CrawlSpider):
    name = 'reproductive'
    allowed_domains = ['reproductive-health-journal.biomedcentral.com']
    start_urls = ['https://reproductive-health-journal.biomedcentral.com/articles']
